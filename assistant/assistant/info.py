...
class Phone(Field):
    ...
    def __init__(self, value=''):
            ...
            if value:
                ...
                self.values = input("Phones(+48......... or +38..........) (multiple phones can be added with space between them. Pattern has 9 symbols after code): ")
            try:
                for number in self.values.split(' '):
                    print(number)
                    if re.match('^\+48\d{9}$', number) or re.match('^\\+38\d{9}$', number) or number == '':
